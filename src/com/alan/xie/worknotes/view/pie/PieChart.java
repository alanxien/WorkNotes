...
import com.alan.xie.worknotes.common.DensityUtil;
...
public class PieChart extends View {
    ...
    private void init(Context context) {
        ...
        pieRadius = screenW / 4;
        smallMargin = DensityUtil.dip2px(context, 5);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mPieItems != null && mPieItems.length > 0) {
            ...
            for (int i = 0; i < mPieItems.length; i++) {
                ...
                String itemPercentText = df.format(mPieItems[i].getItemValue() / totalValue * 100) + "%";
